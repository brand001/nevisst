...
class BiometricUserVerifierImpl(
    ...
    override fun verifyBiometric(
        ...
        OperationCache.updateOperation(
            ...
            operation.update(
                VerifyUser(
                    verificationMode = VerificationMode.BIOMETRIC,
                    userVerificationContext = biometricUserVerificationContext,
                    biometricUserVerificationHandler = biometricUserVerificationHandler
                )
            )
        )

        biometricUserVerificationContext?.also {
        ...
        } ?: throw IllegalStateException("BiometricUserVerificationContext cannot be null.")
    }
