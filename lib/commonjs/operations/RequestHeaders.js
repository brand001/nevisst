...
exports.RequestHeadersImpl = exports.RequestHeaders = void 0;
/**
...
class RequestHeaders {
   ...
   */
  static create(namesAndValues) {
    return new RequestHeadersImpl(namesAndValues);
  }
}
exports.RequestHeaders = RequestHeaders;
class RequestHeadersImpl extends RequestHeaders {
  constructor(namesAndValues) {
    super();
    this.namesAndValues = namesAndValues;
  }
}
exports.RequestHeadersImpl = RequestHeadersImpl;
