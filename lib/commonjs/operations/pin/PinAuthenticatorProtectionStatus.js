...
exports.PinProtectionStatusUnlockedImpl = exports.PinProtectionStatusUnlocked = exports.PinProtectionStatusLockedOutImpl = exports.PinProtectionStatusLockedOut = exports.PinProtectionStatusLastAttemptFailedImpl = exports.PinProtectionStatusLastAttemptFailed = exports.PinAuthenticatorProtectionStatus = void 0;
/**
 ...
 * the authenticator.
 */
class PinAuthenticatorProtectionStatus {
  /**
 ...
 */
exports.PinAuthenticatorProtectionStatus = PinAuthenticatorProtectionStatus;
class PinProtectionStatusUnlocked extends PinAuthenticatorProtectionStatus {
  /**
...
exports.PinProtectionStatusUnlocked = PinProtectionStatusUnlocked;
class PinProtectionStatusUnlockedImpl extends PinProtectionStatusUnlocked {
  static fromJson() {
 ...
 */
exports.PinProtectionStatusUnlockedImpl = PinProtectionStatusUnlockedImpl;
class PinProtectionStatusLastAttemptFailed extends PinAuthenticatorProtectionStatus {
  /**
...
exports.PinProtectionStatusLastAttemptFailed = PinProtectionStatusLastAttemptFailed;
class PinProtectionStatusLastAttemptFailedImpl extends PinProtectionStatusLastAttemptFailed {
 ...
 */
exports.PinProtectionStatusLastAttemptFailedImpl = PinProtectionStatusLastAttemptFailedImpl;
class PinProtectionStatusLockedOut extends PinAuthenticatorProtectionStatus {
  /**
...
exports.PinProtectionStatusLockedOut = PinProtectionStatusLockedOut;
class PinProtectionStatusLockedOutImpl extends PinProtectionStatusLockedOut {
  static fromJson() {
    return new PinProtectionStatusLockedOutImpl();
  }
}
exports.PinProtectionStatusLockedOutImpl = PinProtectionStatusLockedOutImpl;
