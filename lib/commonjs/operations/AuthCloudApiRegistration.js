...
exports.AuthCloudApiRegistrationImpl = exports.AuthCloudApiRegistration = void 0;
...
var _AuthCloudApiErrorConverter = require("../error/authCloudApi/AuthCloudApiErrorConverter");
...
var _AuthCloudApiRegistrationMessage = require("../model/messages/out/AuthCloudApiRegistrationMessage");
 ...
 */
class AuthCloudApiRegistration extends _HttpOperation.HttpOperation {}
exports.AuthCloudApiRegistration = AuthCloudApiRegistration;
class AuthCloudApiRegistrationImpl extends _HttpOperation.HttpOperationImpl {
  enrollResponse(enrollResponse) {
  ...
  async execute() {
    ...
    return _MobileAuthenticationSdk.default.authCloudApiRegister(message).then(() => {
      ...
      var _this$_onError;
      finish();
      const authCloudApiError = new _AuthCloudApiErrorConverter.AuthCloudApiErrorConverter(error).convert();
      (_this$_onError = this._onError) === null || _this$_onError === void 0 || _this$_onError.call(this, authCloudApiError);
    });
  }
}
exports.AuthCloudApiRegistrationImpl = AuthCloudApiRegistrationImpl;
