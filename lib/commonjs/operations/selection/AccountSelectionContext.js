...
exports.AccountSelectionContextImpl = exports.AccountSelectionContext = void 0;
...
exports.AccountSelectionContext = AccountSelectionContext;
class AccountSelectionContextImpl extends AccountSelectionContext {
  ...
  static fromJson(json) {
    const accounts = json.accounts.map(element => _Account.Account.fromJson(element));
  ...
  async isPolicyCompliant(aaid, username) {
    const message = new _IsPolicyCompliantMessage.IsPolicyCompliantMessage(this.operationId, aaid, username);
    return await _MobileAuthenticationSdk.default.isPolicyCompliant(message).then(result => {
      return result.isPolicyCompliant;
    });
  }
}
exports.AccountSelectionContextImpl = AccountSelectionContextImpl;
