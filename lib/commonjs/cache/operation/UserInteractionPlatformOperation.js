...
exports.UserInteractionPlatformOperationImpl = exports.UserInteractionPlatformOperation = void 0;
var _PlatformOperation = require("./PlatformOperation");
var _Aaid = require("../../localData/Aaid");
var _PinChangeHandler = require("../../operations/pin/PinChangeHandler");
var _PinEnrollmentHandler = require("../../operations/pin/PinEnrollmentHandler");
var _AccountSelectionHandler = require("../../operations/selection/AccountSelectionHandler");
var _AuthenticatorSelectionHandler = require("../../operations/selection/AuthenticatorSelectionHandler");
/**
 ...
 * channel calls.
 */
class UserInteractionPlatformOperation extends _PlatformOperation.PlatformOperation {
  /**
...
exports.UserInteractionPlatformOperation = UserInteractionPlatformOperation;
class UserInteractionPlatformOperationImpl extends UserInteractionPlatformOperation {
  constructor(operationId, authenticatorSelector, accountSelector, biometricUserVerifier, devicePasscodeUserVerifier, fingerprintUserVerifier, pinUserVerifier, pinChanger, pinEnroller) {
    ...
    this.accountSelectionHandler = new _AccountSelectionHandler.AccountSelectionHandlerImpl(operationId);
    this.authenticatorSelectionHandler = new _AuthenticatorSelectionHandler.AuthenticatorSelectionHandlerImpl(operationId);
    this.pinEnrollmentHandler = new _PinEnrollmentHandler.PinEnrollmentHandlerImpl(operationId);
    this.pinChangeHandler = new _PinChangeHandler.PinChangeHandlerImpl(operationId);
  }
}
exports.UserInteractionPlatformOperationImpl = UserInteractionPlatformOperationImpl;
