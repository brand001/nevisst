...
exports.DeregistrationMessage = void 0;
var _TypedAuthorizationProvider = require("../../../model/typed/TypedAuthorizationProvider");
/**
...
class DeregistrationMessage {
  ...
  constructor(operationId, onSuccessProvided, onErrorProvided, requestHeaders, authorizationProvider, username, aaid) {
    ...
    if (authorizationProvider) {
      this.authorizationProvider = _TypedAuthorizationProvider.TypedAuthorizationProvider.create(authorizationProvider);
    }
  }
}
exports.DeregistrationMessage = DeregistrationMessage;
