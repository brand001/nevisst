...
exports.MobileAuthenticationClientImpl = void 0;
var _LocalData = require("./localData/LocalData");
...
class MobileAuthenticationClientImpl {
  get operations() {
    return new _Operations.OperationsImpl();
  }
  get localData() {
    return new _LocalData.LocalDataImpl();
  }
}
exports.MobileAuthenticationClientImpl = MobileAuthenticationClientImpl;
