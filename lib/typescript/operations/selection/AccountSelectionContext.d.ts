 ...
 */
export declare abstract class AccountSelectionContext {
    /**
     * The accounts that have been registered with the SDK.
     */
    abstract accounts: Array<Account>;
    /**
     ...
     * otherwise.
     */
    abstract isPolicyCompliant(authenticatorAaid: string, username: string): Promise<boolean>;
    /**
     ...
     */
    static fromJson(json: any): AccountSelectionContext;
}
export declare class AccountSelectionContextImpl extends AccountSelectionContext {
    operationId: string;
    accounts: Array<Account>;
    authenticators: Array<Authenticator>;
    transactionConfirmationData?: string;
    constructor(operationId: string, accounts: Array<Account>, authenticators: Array<Authenticator>, transactionConfirmationData?: string);
    static fromJson(json: any): AccountSelectionContextImpl;
    isPolicyCompliant(aaid: string, username: string): Promise<boolean>;
}
//# sourceMappingURL=AccountSelectionContext.d.ts.map