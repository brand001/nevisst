 ...
 */
export declare abstract class PinUserVerifier {
    /**
     ...
     */
    abstract verifyPin(context: PinUserVerificationContext, handler: PinUserVerificationHandler): Promise<void>;
    /**
...
//# sourceMappingURL=PinUserVerifier.d.ts.map