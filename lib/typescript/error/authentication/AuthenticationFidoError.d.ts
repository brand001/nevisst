 ...
 */
export declare class AuthenticationFidoError extends AuthenticationError {
    /**
     ...
     */
    constructor(errorCode: FidoErrorCode, description: string, cause?: string, sessionProvider?: SessionProvider);
}
//# sourceMappingURL=AuthenticationFidoError.d.ts.map