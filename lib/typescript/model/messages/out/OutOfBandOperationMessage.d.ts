 ...
 */
export declare class OutOfBandOperationMessage implements OperationMessage, HttpOperationMessage {
    /**
     ...
     */
    constructor(operationId: string, subOperationId: string, onSuccessProvided: boolean, onErrorProvided: boolean, requestHeaders?: RequestHeaders, payload?: OutOfBandPayload, onRegistrationProvided?: boolean, onAuthenticationProvided?: boolean);
}
//# sourceMappingURL=OutOfBandOperationMessage.d.ts.map