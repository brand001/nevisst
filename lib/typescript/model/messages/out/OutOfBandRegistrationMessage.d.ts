 ...
 */
export declare class OutOfBandRegistrationMessage implements UserInteractionOperationMessage, HttpOperationMessage {
    /**
     ...
     */
    constructor(operationId: string, accountSelectorProvided: boolean, authenticatorSelectorProvided: boolean, pinEnrollerProvided: boolean, pinUserVerifierProvided: boolean, biometricUserVerifierProvided: boolean, devicePasscodeUserVerifierProvided: boolean, fingerprintUserVerifierProvided: boolean, onSuccessProvided: boolean, onErrorProvided: boolean, requestHeaders?: RequestHeaders, deviceInformation?: DeviceInformation, pinPolicy?: PinPolicy, allowClass2AndroidSensors?: boolean, allowDevicePasscodeAsFallback?: boolean, invalidateOnNewOsBiometrics?: boolean);
}
//# sourceMappingURL=OutOfBandRegistrationMessage.d.ts.map