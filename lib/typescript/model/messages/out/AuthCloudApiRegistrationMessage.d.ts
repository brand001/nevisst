...
/**
 * Holds the parameters of the Auth Cloud registration operation call.
 */
export declare class AuthCloudApiRegistrationMessage implements UserInteractionOperationMessage, HttpOperationMessage {
    /**
    ...
    /**
     * The response to the [Authentication Cloud API enroll](https://docs.nevis.net/apidoc/authcloud/#enroll-your-access-app)
     * request.
     */
    enrollResponse?: string;
    /**
     * The value of the `appLinkUri` attribute in the enroll response sent by the server.
     */
    appLinkUri?: string;
    /**
     ...
     * @param enrollResponse the response to the [Authentication Cloud API enroll](https://docs.nevis.net/apidoc/authcloud/#enroll-your-access-app)
     * request.
     ...
     */
    constructor(operationId: string, accountSelectorProvided: boolean, authenticatorSelectorProvided: boolean, pinEnrollerProvided: boolean, pinUserVerifierProvided: boolean, biometricUserVerifierProvided: boolean, devicePasscodeUserVerifierProvided: boolean, fingerprintUserVerifierProvided: boolean, onSuccessProvided: boolean, onErrorProvided: boolean, requestHeaders?: RequestHeaders, enrollResponse?: string, appLinkUri?: string, deviceInformation?: DeviceInformation, pinPolicy?: PinPolicy, allowClass2AndroidSensors?: boolean, allowDevicePasscodeAsFallback?: boolean, invalidateOnNewOsBiometrics?: boolean);
}
//# sourceMappingURL=AuthCloudApiRegistrationMessage.d.ts.map