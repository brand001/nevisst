 ...
 * users) or not.
 */
export class OsUserEnrollment extends UserEnrollment {
  /**
 ...
 */
export class SdkUserEnrollment extends UserEnrollment {
  /**
...
class SdkUserEnrollmentImpl extends SdkUserEnrollment {
  ...
  static fromJson(json) {
    ...
    const accounts = enrolledAccountsData.map(element => Account.fromJson(element));
