...
class AuthCloudApiRegistrationMessage: UserInteractionOperationMessage {
	// MARK: Properties

	let enrollResponse: String?
	let appLinkUri: String?
	...
	required init(from decoder: Decoder) throws {
		...
		self.enrollResponse = try container.decodeIfPresent(String.self, forKey: .enrollResponse)
		self.appLinkUri = try container.decodeIfPresent(String.self, forKey: .appLinkUri)
